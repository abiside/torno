...
export const CONTINUE_PROMPT = stripIndents`
  Continúa tu respuesta anterior. IMPORTANTE: reanuda exactamente donde te quedaste, sin interrupciones.
  No repitas contenido previo, incluidas etiquetas de artefactos ni de acciones.
`;
