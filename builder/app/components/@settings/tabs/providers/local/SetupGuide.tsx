...
function SetupGuide({ onBack }: { onBack: () => void }) {
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-gradient-to-r from-logoPink-500/12 to-accent-500/10 border border-logoPink-500/25 shadow-sm">
      ...
      <Card className="bg-bolt-elements-background-depth-2 shadow-sm">
        <CardHeader className="pb-6">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-logoPink-500/22 to-logoPink-600/20 flex items-center justify-center ring-1 ring-logoPink-500/30">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-3 rounded-lg bg-bolt-elements-background-depth-3">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full bg-gradient-to-r from-logoPink-500/10 to-logoPink-600/10 hover:from-logoPink-500/20 hover:to-logoPink-600/20 border-logoPink-500/30 hover:border-logoPink-500/50 transition-all duration-300 gap-2 group shadow-sm hover:shadow-lg hover:shadow-logoPink-500/20 font-medium"
                    _asChild
                  >
                    <a
      ...
      <Card className="bg-gradient-to-r from-accent-500/10 to-logoPink-500/14 border border-logoPink-500/25 shadow-sm">
