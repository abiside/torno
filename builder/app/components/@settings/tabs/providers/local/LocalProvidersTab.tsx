      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-accent-500/20 to-logoPink-500/22 flex items-center justify-center ring-1 ring-logoPink-500/25">
                    ...
                    {isLoadingModels ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        <Button
                          variant="outline"
                          size="sm"
                          className="bg-gradient-to-r from-logoPink-500/10 to-logoPink-600/10 hover:from-logoPink-500/18 hover:to-logoPink-600/18 border-logoPink-500/25 hover:border-logoPink-500/40 transition-all duration-300 gap-2 group shadow-sm hover:shadow-md font-medium"
                          _asChild
                        >
                          <a
                            href="https://ollama.com/library"
                    ...
                    {isLoadingLMStudioModels ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        <Button
                          variant="outline"
                          size="sm"
                          className="bg-gradient-to-r from-accent-500/10 to-logoPink-500/10 hover:from-accent-500/16 hover:to-logoPink-500/16 border-logoPink-500/25 hover:border-logoPink-500/40 transition-all duration-300 gap-2 group shadow-sm hover:shadow-md font-medium"
                          _asChild
                        >
                          <a
