...
const classicWorkbenchSlider: SliderOptions<WorkbenchViewType> = {
  left: { value: 'code', text: 'Code' },
  middle: { value: 'diff', text: 'Diff' },
  right: { value: 'preview', text: 'Preview' },
};

/** Preview first for no-code product mode */
const noCodeWorkbenchSlider: SliderOptions<WorkbenchViewType> = {
  left: { value: 'preview', text: 'Preview' },
  middle: { value: 'code', text: 'Code' },
...
export const Workbench = memo(
  ({
    ...
    const workbenchSliderOptions = useMemo(
      () => (simpleExperience ? noCodeWorkbenchSlider : classicWorkbenchSlider),
      [simpleExperience],
    );
    ...
    useEffect(() => {
      ...
      return workbenchStore.currentView.subscribe((view) => {
        if (view !== 'preview') {
          queueMicrotask(() => workbenchStore.currentView.set('preview'));
        }
      });
    }, [simpleExperience]);
            ...
            <div className="absolute inset-0 px-2 lg:px-4">
              <div className="h-full flex flex-col bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor shadow-sm rounded-lg overflow-hidden">
                <div className="flex items-center px-3 py-2 border-b border-bolt-elements-borderColor gap-1.5">
                  ...
                  />
                  {simpleExperience ? (
                    <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-bolt-elements-item-backgroundAccent text-bolt-elements-item-contentAccent text-sm font-medium">
                      <div className="i-ph:browser" />
                      Preview
                    </div>
                  ) : (
                    <Slider selected={selectedView} options={workbenchSliderOptions} setSelected={setSelectedView} />
                  )}
