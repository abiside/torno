...
${
  skippedFiles.length > 0
    ? `\nArchivos omitidos (${skippedFiles.length}):
${skippedFiles.map((f) => `- ${f}`).join('\n')}`
    : ''
}

<boltArtifact id="imported-files" title="Archivos clonados desde Git" type="bundled">
${fileContents
  .map(
    (file) =>
...
${escapeBoltTags(file.content)}
  ...
  .join('\n')}
      ...
      toast.error('No se pudo importar el repositorio');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <>
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-bolt-elements-textPrimary dark:text-bolt-elements-textPrimary">
                  Elige el proveedor del repositorio
                </h3>
                <button
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-bolt-elements-textSecondary dark:text-bolt-elements-textSecondary">
                        Clonar desde repositorios de GitHub
                      </div>
                    </div>
                  </div>
                </button>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-bolt-elements-textSecondary dark:text-bolt-elements-textSecondary">
                        Clonar desde repositorios de GitLab
                      </div>
                    </div>
                  </div>
                </button>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-bolt-elements-textSecondary dark:text-bolt-elements-textSecondary">
                    Clona un repositorio de GitHub en tu espacio de trabajo
                  </p>
                </div>
              </div>
              <button
          ...
          <div className="bg-white dark:bg-gray-950 rounded-xl shadow-xl border border-bolt-elements-borderColor dark:border-bolt-elements-borderColor w-full max-w-4xl max-h-[90vh] overflow-hidden">
            <div className="p-6 border-b border-bolt-elements-borderColor dark:border-bolt-elements-borderColor flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-bolt-elements-textPrimary dark:text-bolt-elements-textPrimary">
                    Importar repositorio de GitLab
                  </h3>
                  <p className="text-sm text-bolt-elements-textSecondary dark:text-bolt-elements-textSecondary">
                    Clona un repositorio de GitLab en tu espacio de trabajo
                  </p>
                </div>
              </div>
              <button
      ...
      {loading && <LoadingOverlay message="Espera mientras clonamos el repositorio…" />}
    </>
  );
}
